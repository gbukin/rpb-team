...
<template>
    <div>
        <div class="min-h-screen bg-main">
            <nav class="border-b border-primary bg-nav">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <DropdownLink :href="route('register')">Регистрация</DropdownLink>
                            <!-- Settings Dropdown -->
...
<!--                                            <button-->
<!--                                                type="button"-->
<!--                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-card hover:border-card-gray focus:outline-none transition ease-in-out duration-150"-->
<!--                                            >-->
<!--                                                Гость-->
...
<!--                            </div>-->
                ...
                <div
                    ...
                    class="sm:hidden"
                >
                    <div class="pt-2 pb-3 space-y-1 bg-main hover:bg-nav">
